...
const gameDataArray: GameDetail[] = [
  ...
  // ─── Unturned ───
  {
    ...
    description: "Unturned es un juego de supervivencia zombie gratuito donde puedes explorar, construir bases, recolectar recursos y sobrevivir con amigos.",
  ...
  // ─── Arma Reforger ───
  {
    ...
    description: "Arma Reforger es el puente hacia Arma 4, ofreciendo combate militar autentico con graficos de nueva generacion y juego cruzado entre PC y consolas.",
