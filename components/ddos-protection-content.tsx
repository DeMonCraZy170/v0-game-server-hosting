...
const allGames: GameData[] = [
  ...
  { name: "San Andreas Multiplayer", image: "/images/games/samp.jpg", price: "$7.99/mo", platforms: ["pc"] },
  { name: "Multi Theft Auto", image: "/images/games/mta.jpg", price: "$7.99/mo", platforms: ["pc"] },
