...
const allGames: GameData[] = [
  // Popular games with WHMCS links
  { name: "Minecraft Java", image: "/images/games/minecraft.jpg", price: "$5.99/mo", popular: true, platforms: ["pc", "java"] },
  { name: "DayZ", image: "/images/games/dayz.jpg", price: "$24.99/mo", popular: true, isNew: true, platforms: ["steam"] },
  ...
  { name: "Arma Reforger", image: "/images/games/armareforger.jpg", price: "$19.99/mo", isNew: true, platforms: ["steam"] },
