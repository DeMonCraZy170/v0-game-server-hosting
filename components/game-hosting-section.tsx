...
const hostingCategories = [
  ...
  {
    icon: "/images/icon-rust.jpg",
    iconWidth: 70,
    iconHeight: 70,
    title: "Rust",
    subtitle: "Hosting",
    description:
      "Servidores Rust de alto rendimiento con proteccion DDoS y soporte 24/7 para la mejor experiencia de supervivencia.",
    features: ["Alto Rendimiento", "Proteccion DDoS", "Soporte 24/7"],
    cta: "Encontrar Mi Hosting Rust",
  ...
  },
  {
    ...
    cta: "Encontrar Mi Hosting RAGE-MP",
    href: "/game-server-hosting/rage-mp",
    accentColor: "#e11d48",
