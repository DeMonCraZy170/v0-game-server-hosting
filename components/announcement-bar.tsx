    ...
    <div className="bg-[#1a1a1a] border-b-2 border-primary">
      <div className="mx-auto max-w-7xl px-4 py-2 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-4">
          <a href="https://panel.forzahost.com" target="_blank" rel="noopener noreferrer" className="text-[15px] font-semibold text-foreground/80 hover:text-foreground transition-colors flex items-center gap-1.5">
          ...
          <a href="https://billing.forzahost.com" target="_blank" rel="noopener noreferrer" className="text-[15px] font-semibold text-foreground/80 hover:text-foreground transition-colors flex items-center gap-1.5">
