  ...
  return (
    <section className="py-20 bg-secondary">
      <div className="mx-auto max-w-7xl px-4">
        <div className="relative bg-gradient-to-br from-primary/10 via-card to-card border border-primary/20 rounded-3xl p-8 md:p-12 lg:p-16 overflow-hidden">
            ...
            <div className="flex-shrink-0">
              <div className="w-48 h-48 md:w-56 md:h-56 rounded-3xl bg-primary/10 border border-primary/20 flex items-center justify-center">
                <div className="text-center">
                  <span className="text-5xl md:text-6xl font-bold text-primary" style={{ fontFamily: 'var(--font-heading)' }}>24</span>
